...
dig '@127.0.0.1' -p $DNS_PORT google.com +short

Write-Host "Testing DNS from $HostIP`:"
dig "@$HostIP" -p $DNS_PORT google.com +short
...
$interfaces = ifconfig | Select-String -Pattern "^[a-z]|inet " | Where-Object { $_ -notmatch "127.0.0.1" }
