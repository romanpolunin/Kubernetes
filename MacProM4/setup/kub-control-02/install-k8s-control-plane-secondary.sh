...
# 9. Create kubeadm config file to set join parameters
...
controlPlane:
  localAPIEndpoint:
    advertiseAddress: ${KUB_CONTROL_PLANE_02}
    bindPort: 6443
  certificateKey: ${KUB_CERT_KEY}
EOF

# 10. Join existing Kubernetes cluster as a secondary control plane node
